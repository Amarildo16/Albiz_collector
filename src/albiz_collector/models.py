...
class AppCompanyFeature(Base):
    ...
    near_budget_limit_count: Mapped[int] = mapped_column(Integer)
    near_budget_limit_rate: Mapped[float] = mapped_column(Numeric(10, 4))
    winner_value_gt_budget_count: Mapped[int] = mapped_column(Integer)
    winner_value_gt_budget_rate: Mapped[float] = mapped_column(Numeric(10, 4))
    ...
    top_authority_name: Mapped[str | None] = mapped_column(Text, nullable=True)
    top_authority_count: Mapped[int] = mapped_column(Integer)
    top_authority_share: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    authority_hhi: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    top_procedure_type: Mapped[str | None] = mapped_column(String(255), nullable=True)
    top_procedure_type_count: Mapped[int] = mapped_column(Integer)
    top_procedure_type_share: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    procedure_type_hhi: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    yoy_value_jump_count: Mapped[int] = mapped_column(Integer)
    yoy_contract_count_jump_count: Mapped[int] = mapped_column(Integer)
    max_yoy_value_growth_ratio: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
    max_yoy_contract_count_growth_ratio: Mapped[float | None] = mapped_column(Numeric(18, 6), nullable=True)
