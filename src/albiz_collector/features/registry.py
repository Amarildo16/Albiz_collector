...
APP_FEATURES: tuple[FeatureDefinition, ...] = (
    ...
    FeatureDefinition("near_budget_limit_count", "app_company_features", "budget_proximity", "caution", "Count of eligible APP rows where winner value is 95% to 100% of positive budget limit."),
    FeatureDefinition("near_budget_limit_rate", "app_company_features", "budget_proximity", "caution", "Share of positive-budget rows with winner value where winner value is 95% to 100% of budget."),
    FeatureDefinition("winner_value_gt_budget_count", "app_company_features", "budget_proximity", "caution", "Count of eligible APP rows where winner value exceeds positive budget limit."),
    FeatureDefinition("winner_value_gt_budget_rate", "app_company_features", "budget_proximity", "caution", "Share of positive-budget rows with winner value where winner value exceeds budget."),
    ...
    FeatureDefinition("top_authority_name", "app_company_features", "concentration", "caution", "Most frequent contracting authority for the winner NIPT where authority is present."),
    FeatureDefinition("top_authority_count", "app_company_features", "concentration", "safe", "Count of rows for the most frequent contracting authority where authority is present."),
    FeatureDefinition("top_authority_share", "app_company_features", "concentration", "caution", "Share of authority-present rows belonging to the most frequent contracting authority."),
    FeatureDefinition("authority_hhi", "app_company_features", "concentration", "caution", "Herfindahl-Hirschman concentration index over contracting authorities."),
    FeatureDefinition("top_procedure_type", "app_company_features", "concentration", "caution", "Most frequent APP procedure type for the winner NIPT where procedure type is present."),
    FeatureDefinition("top_procedure_type_count", "app_company_features", "concentration", "safe", "Count of rows for the most frequent procedure type where procedure type is present."),
    FeatureDefinition("top_procedure_type_share", "app_company_features", "concentration", "caution", "Share of procedure-present rows belonging to the most frequent procedure type."),
    FeatureDefinition("procedure_type_hhi", "app_company_features", "concentration", "caution", "Herfindahl-Hirschman concentration index over APP procedure types."),
    FeatureDefinition("yoy_value_jump_count", "app_company_features", "year_over_year", "caution", "Count of consecutive publication-year winner-value jumps meeting ratio and absolute-increase thresholds."),
    FeatureDefinition("yoy_contract_count_jump_count", "app_company_features", "year_over_year", "caution", "Count of consecutive publication-year contract-count jumps meeting ratio and absolute-increase thresholds."),
    FeatureDefinition("max_yoy_value_growth_ratio", "app_company_features", "year_over_year", "caution", "Maximum consecutive-year winner-value growth ratio where prior-year value is positive."),
    FeatureDefinition("max_yoy_contract_count_growth_ratio", "app_company_features", "year_over_year", "caution", "Maximum consecutive-year contract-count growth ratio where prior-year count is positive."),
